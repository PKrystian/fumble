...
module.exports = {
  'shadar-kai-shadow-dancer': {
    ...
    traits: [
      {
        name: 'Dziedzictwo Fey',
        entries: [
          'Shadar-kai ma przewagę w rzutach obronnych przeciw {@condition charmed}, a magia nie może go uśpić.',
        ],
      },
    ],
    actions: [
            ...
            items: [
              {
                name: '1-2: Rozkład',
                type: 'item',
                entries: ['Cel otrzymuje 22 ({@damage 4d10}) obrażeń nekrotycznych.'],
              },
              {
                name: '3-4: Chwyt',
                type: 'item',
                entries: [
                  'Cel zostaje {@condition grappled} (ucieczka {@dc 14}), jeśli jest Średnim lub mniejszym stworzeniem. Dopóki chwyt trwa, cel jest {@condition restrained}, a shadar-kai nie może chwycić innego celu.',
                ],
              },
              {
                name: '5-6: Powalenie',
                type: 'item',
                entries: ['Cel zostaje powalony.'],
              },
            ],
          },
        ],
    ...
    bonusActions: [
      {
        name: 'Cienisty Skok',
        entries: [
          'Shadar-kai teleportuje się, wraz z całym noszonym lub niesionym ekwipunkiem, na odległość do 30 stóp do widzianej wolnej przestrzeni. Zarówno przestrzeń, z której się teleportuje, jak i przestrzeń, do której się teleportuje, muszą być w półmroku lub ciemności.',
        ],
      },
    ],
    lore: shadarKaiLore,
  ...
  'shadar-kai-soul-monger': {
    ...
    traits: [
      ...
      },
      {
        ...
        entries: [
          'Shadar-kai ma przewagę w rzutach obronnych przeciw czarom i innym magicznym efektom.',
        ],
      },
      {
        name: 'Pragnienie Dusz',
        entries: [
          'Gdy zredukuje stworzenie do 0 punktów wytrzymałości, shadar-kai może zyskać tymczasowe punkty wytrzymałości równe połowie maksimum punktów wytrzymałości tego stworzenia. Dopóki shadar-kai ma tymczasowe punkty wytrzymałości z tej cechy, ma przewagę w rzutach na trafienie.',
        ],
      },
      {
        name: 'Brzemię Wieków',
        entries: [
          'Dowolna Bestia lub Humanoid (poza elfem), który rozpoczyna swoją turę w promieniu 5 stóp od shadar-kai, ma prędkość zmniejszoną o 20 stóp do początku swojej następnej tury.',
        ],
      },
    ],
    spellcasting: [
    ...
    traits: [
      {
        name: 'Amorficzny',
        entries: [
          'Cień może poruszać się przez przestrzeń tak wąską jak 1 cal, nie wydatkując na to dodatkowego ruchu.',
        ],
      },
      {
        name: 'Słabość na Światło Słoneczne',
        entries: [
          'Przebywając w świetle słonecznym, cień ma {@variantrule Disadvantage|XPHB} w {@variantrule D20 Test|XPHB|Testach K20}.',
        ],
      },
    ],
    actions: [
      {
        name: 'Wysysające Machnięcie',
        entries: [
          '{@atkr m} {@hit 4}, zasięg 5 stóp. {@h}5 ({@damage 1d6 + 2}) obrażeń nekrotycznych, a wartość Siły celu zmniejsza się o {@dice 1d4}. Cel umiera, jeśli redukuje to tę wartość do 0. Jeśli Humanoid zostanie zabity tym atakiem, Cień powstaje ze zwłok {@dice 1d4} godzin później.',
        ],
      },
    ],
    bonusActions: [
      {
        name: 'Cienista Skrytość',
        entries: [
          'Będąc w {@variantrule Dim Light|XPHB} lub {@variantrule Darkness|XPHB}, cień wykonuje akcję {@action Hide|XPHB}.',
        ],
      },
    ],
    lore: [
      {
        ...
        entries: [
            ...
            items: [
              {
                ...
                name: 'Siedlisko:',
                entry:
                  '{@filter Płaszczyznowy (Cienista Otchłań)|bestiary|environment=planar, shadowfell}, {@filter Podmrok|bestiary|environment=underdark}, {@filter Miasto|bestiary|environment=urban}',
              },
          ...
          {
            type: 'table',
            caption: 'Kształty Cienia',
            colLabels: ['k6', 'Cień Pojawia Się Jako...'],
    ...
    traits: [
      {
        name: 'Amorficzny',
        entries: [
          'Cień może poruszać się przez przestrzeń tak wąską jak 1 cal, bez konieczności przeciskania się.',
        ],
      },
      {
        name: 'Cienista Skrytość',
        entries: [
          'Będąc w półmroku lub ciemności, cień może wykonać akcję {@action Hide} jako akcję dodatkową. Jego premia do skradania jest też zwiększona do +6.',
        ],
      },
      {
        name: 'Słabość na Światło Słoneczne',
        entries: [
          'Przebywając w świetle słonecznym, cień ma utrudnienie w rzutach na trafienie, testach cech i rzutach obronnych.',
        ],
      },
    ],
    actions: [
      {
        name: 'Wysysanie Siły',
        entries: [
          '{@atk mw} {@hit 4} do trafienia, zasięg 5 stóp, jedno stworzenie. {@h}9 ({@damage 2d6 + 2}) obrażeń nekrotycznych, a wartość Siły celu zostaje zmniejszona o {@dice 1d4}. Cel umiera, jeśli redukuje to jego Siłę do 0. W przeciwnym razie redukcja trwa, dopóki cel nie zakończy krótkiego lub długiego odpoczynku.',
        ...
        entries: [
          {
            ...
            entries: [
              ...
              {
                name: 'Natura Nieumarłego',
                type: 'entries',
                entries: ['Cień nie potrzebuje powietrza, jedzenia, picia ani snu'],
              },
            ],
          },
        ],
  ...
  'shadow-dancer': {
    ...
    actions: [
      {
        name: 'Wieloatak',
        entries: ['Cienista tancerka wykonuje trzy ataki kolczastym łańcuchem.'],
      },
      {
        name: 'Kolczasty Łańcuch',
        entries: [
                ...
                entries: [
                  {
                    ...
                    type: 'entries',
                    entries: [
                      'Shadar-kai czuwają zarówno nad Cienistą Otchłanią, jak i światem materialnym, wypatrując wybranych dusz i tragedii, które mogłyby zadowolić ich boginię. Krążą plotki, że potrafią kierować światowymi wydarzeniami ku tragicznym ścieżkom dla jej rozrywki. Kruca Królowa jest jednak notorycznie zagadkowa nawet wobec swych najbardziej oddanych wyznawców. Wysiłki shadar-kai są wynagradzane jedynie niejasnymi omenami, które interpretują najlepiej, jak potrafią.',
                    ],
                  },
                  {
                    name: 'Zwiędnięte Elfy',
                    type: 'entries',
                    entries: [
                      'Shadar-kai byli niegdyś elfami, lecz eony wystawienia na osłabiający wpływ Cienistej Otchłani uczyniły ich pozbawionymi radości i żałobnymi. W tej krainie mają wygląd uschniętych elfów: blade włosy, pomarszczoną szarą skórę i spuchnięte stawy, które nadają im trupi wygląd. Wyglądają młodziej na innych płaszczyznach, lecz ich skóra zawsze zachowuje swą śmiertelną bladość. Ubierają się w mroczne płaszcze i ciężkie welony, nienawidzą luster i unikają trzymania rzeczy przypominających im o ich wieku.',
                    ],
                  },
                ],
              },
  ...
  'shadow-demon': {
    ...
    traits: [
      {
        name: 'Demoniczne Odrodzenie',
        entries: [
          'Jeśli demon umiera poza Otchłanią, jego ciało rozpuszcza się w ichor, i natychmiast zyskuje nowe ciało, odradzając się ze wszystkimi {@variantrule Hit Points|XPHB} gdzieś w Otchłani.',
        ],
      },
      {
        name: 'Ruch Bezcielesny',
        entries: [
          'Demon może poruszać się przez inne stworzenia i przedmioty, jakby były {@variantrule Difficult Terrain|XPHB}. Otrzymuje 5 ({@damage 1d10}) obrażeń siłowych, jeśli zakończy swoją turę wewnątrz przedmiotu.',
        ],
      },
      {
        name: 'Wrażliwość na Światło',
        entries: [
          'Będąc w {@variantrule Bright Light|XPHB}, demon ma {@variantrule Disadvantage|XPHB} w testach cech i rzutach na trafienie.',
        ],
      },
    ],
    actions: [
      {
        name: 'Mroczny Pazur',
        entries: [
          '{@atkr m} {@hit 5}, zasięg 5 stóp. {@h}16 ({@damage 3d8 + 3}) obrażeń psychicznych.',
        ],
      },
    ],
    bonusActions: [
      {
        name: 'Cienista Skrytość',
        entries: [
          'Będąc w {@variantrule Dim Light|XPHB} lub {@variantrule Darkness|XPHB}, demon wykonuje akcję {@action Hide|XPHB}.',
        ],
      },
    ],
    lore: [
            ...
            items: [
              {
                ...
                name: 'Siedlisko:',
                entry:
                  '{@filter Płaszczyznowy (Otchłań)|bestiary|environment=planar, abyss}',
              },
              { type: 'item', name: 'Skarb:', entry: 'Brak' },
            ],
          },
            ...
            entries: [
              {
                ...
                entries:
                  [
                    'Istnieją trzy zasady zakończeń. Po pierwsze, dobro zawsze zwycięża. Po drugie, zło zawsze powraca. Po trzecie, pierwsza zasada nie zawsze jest prawdziwa.',
                  ] - splice,
                by: 'Tarsheva Longreach, Podróżniczka Płaszczyzn',
              },
            ],
          },
        ],
