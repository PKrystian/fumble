...
import { Button, IconButton, Select, TextInput } from '@/features/ui/primitives';
    ...
    <div className="mx-auto max-w-4xl px-6 py-8">
      <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <IconButton onClick={previous} label={t('initiative.previousTurn')}>
            <ChevronLeft size={18} />
          </IconButton>
      ...
      {characters.length > 0 && (
        <div
          className={panelClass('mb-4 flex flex-wrap items-end gap-2 border-ink-700 p-4')}
        >
          ...
          />
          <Button onClick={addFromRoster} disabled={!rosterId} variant="primary">
      ...
      <div
        className={panelClass('mb-6 flex flex-wrap items-end gap-2 border-ink-700 p-4')}
      >
        <label className="flex flex-1 flex-col gap-1 text-sm">
          <span className="text-xs font-semibold text-ink-400">
            {t('initiative.name')}
        ...
        />
        <IconButton
          label={t('initiative.rollInitiative')}
            ...
            >
              ...
              <label className="flex items-center gap-1 text-sm text-ink-300">
                ...
                <TextInput
                  ...
                  className="min-h-8 w-14 px-1 py-0.5 text-center"
                />
              ...
              <TextInput
                ...
                className="min-h-8 w-32 py-0.5"
              />
              <IconButton
                label={t('initiative.removeCombatant', { name: c.name })}
