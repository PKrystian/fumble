const en = {
  ...
  compendium: {
    ...
    seo: {
      categoryTitle: '{{category}} - D&D 2024 Compendium',
      categoryDescriptionFallback: "Browse {{category}} in Fumble's D&D 2024 compendium.",
      categoryDescriptions: {
        species:
          'Browse D&D 2024 species, ancestry traits, sizes, speeds, and features for player characters.',
        classes: 'Browse D&D 2024 classes, level progression, features, and subclasses.',
        backgrounds:
          'Browse D&D 2024 backgrounds, ability scores, skills, tools, and origin feats.',
        feats: 'Browse D&D 2024 feats and prerequisites for character builds.',
        optionalfeatures:
          'Browse optional features, fighting styles, and other D&D 2024 character options.',
        spells:
        ...
        conditions:
          'Browse D&D 2024 conditions, diseases, and statuses with their effects.',
        rules:
          'Browse D&D 2024 rules and rule references for players and Dungeon Masters.',
        deities: 'Browse D&D deities, pantheons, domains, and related lore.',
        hazards: 'Browse D&D hazards and environmental threats for adventures.',
        boons: 'Browse D&D boons and supernatural rewards for characters.',
        skills: 'Browse D&D skills and the abilities used for checks.',
        senses: 'Browse D&D senses and special perception rules.',
        languages: 'Browse D&D languages, scripts, and typical speakers.',
        cultsboons: 'Browse D&D cults, cult features, and boons for campaign building.',
        facilities: 'Browse D&D bastion facilities, levels, spaces, and orders.',
        recipes: 'Browse D&D recipes, ingredients, servings, and crafting effects.',
        objects: 'Browse D&D objects with armor class, hit points, size, and traits.',
        vehicles: 'Browse D&D vehicles, speeds, capacities, and travel details.',
        masteries: 'Browse D&D weapon masteries and the properties they add to attacks.',
        charoptions: 'Browse D&D character options, prerequisites, and feature choices.',
        tables: 'Browse D&D tables and random results for campaign play.',
        decks: 'Browse D&D card decks and their card counts and contents.',
        psionics: 'Browse psionic options and source data for D&D campaigns.',
        encounters: 'Browse encounter tables and structured D&D encounter data.',
        loot: 'Browse loot tables and treasure results for D&D adventures.',
        life: 'Browse life tables for D&D characters, NPCs, and campaign generation.',
        names: 'Browse D&D name tables for characters, locations, and worldbuilding.',
        monsterfeatures:
          'Browse monster features and special abilities for D&D creatures.',
        homecrafts: 'Browse homecrafting tables and recipes for D&D campaigns.',
      },
      categoryTypes: {
        species: 'species',
        classes: 'class',
        ...
        senses: 'sense',
        languages: 'language',
        cultsboons: 'cult or boon',
        facilities: 'bastion facility',
        recipes: 'recipe',
        objects: 'object',
        vehicles: 'vehicle',
        masteries: 'weapon mastery',
        charoptions: 'character option',
        tables: 'table',
        decks: 'deck',
        psionics: 'psionic option',
      ...
      details: {
        level: 'level {{value}}',
        school: 'school {{value}}',
        castingTime: 'casting time {{value}}',
        range: 'range {{value}}',
        duration: 'duration {{value}}',
        hitDie: 'hit die {{value}}',
        primaryAbility: 'primary ability {{value}}',
        savingThrows: 'saving throws {{value}}',
        creatureType: 'creature type {{value}}',
        size: '{{value}} size',
        speed: 'speed {{value}}',
        rarity: '{{value}} rarity',
        itemType: 'type {{value}}',
        ...
        hitPoints: 'hit points {{value}}',
        challengeRating: 'challenge rating {{value}}',
        abilityScores: 'ability scores {{value}}',
        skills: 'skills {{value}}',
        tools: 'tools {{value}}',
        feat: 'feat {{value}}',
        prerequisite: 'prerequisite {{value}}',
        featureType: 'feature type {{value}}',
        kind: 'kind {{value}}',
        ruleType: 'rule type {{value}}',
        pantheon: 'pantheon {{value}}',
        domains: 'domains {{value}}',
        hazardType: 'hazard type {{value}}',
        boonType: 'boon type {{value}}',
        ability: 'ability {{value}}',
        languageType: 'language type {{value}}',
        script: 'script {{value}}',
        typicalSpeakers: 'typical speakers {{value}}',
        category: 'category {{value}}',
        facilityType: 'facility type {{value}}',
        space: 'space {{value}}',
        orders: 'orders {{value}}',
        recipeType: 'recipe type {{value}}',
        serves: 'serves {{value}}',
        diet: 'diet {{value}}',
    ...
    filters: {
      ...
      all: 'All',
      clear: 'Clear',
      includeAny: 'Include any habitat',
      clearAll: 'Clear all',
      showLess: 'Show less',
    ...
    classDetail: {
      ...
      overview: 'Overview',
      artificerOverview:
        'Artificers are Intelligence-focused inventors who channel magic through tools, create useful items, and expand their options through a specialized subclass.',
      subclassComparison: 'Artificer subclass comparison',
      subclass: 'Subclass',
      subclassRole: 'Role',
      subclassPlaystyle: 'Playstyle',
      subclasses: {
        alchemist: {
          role: 'Support and utility',
          playstyle:
            'Create elixirs, restore allies, and adapt your magic to the situation.',
        },
        armorer: {
          role: 'Defense and infiltration',
          playstyle:
            'Use Arcane Armor to protect the party or approach encounters discreetly.',
        },
        artillerist: {
          role: 'Ranged damage and control',
          playstyle:
            'Build Eldritch Cannons to pressure enemies and support the battlefield.',
        },
        battleSmith: {
          role: 'Frontline support',
          playstyle:
            'Fight beside a Steel Defender while protecting and repairing allies.',
        },
        cartographer: {
          role: 'Exploration and mobility',
          playstyle:
            'Navigate danger, improve positioning, and open routes for the party.',
        },
        reanimator: {
          role: 'Constructs and necromancy',
          playstyle:
            'Experiment with reanimated companions and unsettling modifications.',
        },
      },
    },
  },
  ...
  encounter: {
    ...
    addRandomMonster: 'Add random monster',
    addRandomMonsterHint:
      'Choose a monster from the high budget up to 10% above it, or the closest stronger option.',
    randomMonsterUnavailable:
      'No suitable stronger monster was found for this party and habitat.',
    crXp: 'CR {{cr}} · {{xp}} XP',
    crValue: 'CR {{cr}}',
    xpValue: '{{xp}} XP',
    fewer: 'Fewer {{name}}',
  ...
  seo: {
    ...
    pageTitles: {
      ...
      data: 'Data Backup',
      sessionLog: 'D&D Session Log',
      initiative: 'D&D Initiative Tracker',
      loot: 'D&D Loot Generator',
      encounter: 'D&D Encounter Builder',
      soundboard: 'D&D Campaign Soundboard',
      wiki: 'D&D Campaign Wiki',
      map: 'Chult Map',
      campaignMap: 'Campaign Map',
    },
    pageDescriptions: {
      character:
        'Create, import, export, and manage private D&D 2024 character sheets in your browser.',
      compendium:
      ...
      data: 'Export or restore all local Fumble characters, settings, notes, and tool data in one backup file.',
      sessionLog:
        'Record D&D session transcripts, notes, and summaries locally in your browser without an account.',
      initiative:
        'Track D&D combatants, initiative, hit points, rounds, turns, and conditions during encounters.',
      loot: 'Generate D&D treasure, hoards, rewards, and magic items by party tier and rarity.',
      encounter:
        'Build D&D encounters, add monsters, and compare encounter XP with the party budget.',
      soundboard:
        'Organize and play D&D campaign ambience, playlists, and combat tracks from YouTube.',
      wiki: 'Browse a public D&D campaign wiki generated from an Obsidian vault.',
      map: 'Explore the player-facing Chult hex map and track discovered areas during a campaign.',
      campaignMap:
        'Explore a player-facing campaign map and track discovered areas during play.',
    },
    bookDescription: 'Read {{name}} in Fumble.',
    bookChapterDescription: 'Read {{chapter}} from {{book}} in Fumble.',
  },
  wiki: {
    ...
    campaignNoPages: 'This campaign does not have any published wiki pages yet.',
    noCampaigns: 'No campaigns are available yet.',
    pageCount: '{{count}} wiki pages',
    chultMap: 'Chult map',
    ...
    mapGridShow: 'Show hex grid',
    mapGridHide: 'Hide hex grid',
    mapEditorOpen: 'Edit revealed hexes',
    mapEditorClose: 'Close map editor',
    mapEditorTitle: 'Local hex editor',
    mapEditorLocalOnly: 'Development only',
    mapEditorDescription:
      'Click a hex to reveal or hide it. Changes stay in this browser. Copy the generated ranges into maps.ts before publishing.',
    mapEditorState: '{{revealed}} of {{total}} hexes revealed',
    mapEditorCopyRanges: 'Copy ranges',
    mapEditorCopied: 'Ranges copied',
    mapEditorReset: 'Reset local changes',
    mapEditorExportLabel: 'Paste this into maps.ts',
    mapEditorHex: 'Hex {{index}}: {{state}}',
    mapEditorRevealed: 'revealed',
    mapEditorHidden: 'hidden',
    chultMapInteractionHint:
      'Use the controls or mouse wheel to zoom. Drag the map after zooming.',
    chultMapSidebarDescription: 'Track the discovered parts of Chult.',
    chultMapAlt: 'Chult map with a hex grid',
    mapUnavailable: 'This campaign map is not available.',
    campaigns: {
  ...
  homebrew: {
    ...
    editFumbleVisibility: 'Configure Compendium content',
    fumbleVisibilityDialog: 'Configure Fumble visibility',
    fumbleVisibilityDescription:
      'Choose the campaigns and content types available when Fumble homebrew is shown in the Compendium.',
    fumbleVisibilityCampaigns: 'Campaigns',
    fumbleVisibilityCategories: 'Content types',
    fumbleVisibilitySelectAllCampaigns: 'Select all campaigns',
    fumbleVisibilityClearCampaigns: 'Clear campaigns',
    fumbleVisibilitySelectAllCategories: 'Select all content types',
    fumbleVisibilityClearCategories: 'Clear content types',
    fumbleVisibilitySelected: '{{count}} Fumble entries selected',
    fumbleVisibilityNoSelection:
      'No entries will be shown. Select at least one campaign and content type, or select all.',
    fumbleVisibilityCancel: 'Cancel',
    fumbleVisibilitySave: 'Save visibility',
    fumbleVisibilityClose: 'Close visibility settings',
    searchFumble: 'Search',
