...
const pl: Dictionary = {
  ...
  compendium: {
    ...
    sourceData: {
      ...
      collections: {
        ...
        lifeBackground: 'Wydarzenie z życia tła',
    ...
    classDetail: {
      ...
      subclasses: {
        ...
        artillerist: {
          ...
          playstyle: 'Buduj Eldritch Cannons, aby nękać wrogów i wspierać pole bitwy.',
        },
        battleSmith: {
  ...
  soundboard: {
    ...
    restoreExamples: 'Przywróć przykład',
  ...
  seo: {
    ...
    pageTitles: {
      ...
      initiative: 'Tracker inicjatywy D&D',
  ...
  wiki: {
    ...
    breadcrumbs: 'Okruszki nawigacji wiki',
    ...
    mapEditorLocalOnly: 'Tylko tryb developerski',
  ...
  homebrew: {
    ...
    fumbleVisibilityDialog: 'Konfiguruj widoczność homebrew Fumble',
    fumbleVisibilityDescription:
      'Wybierz kampanie i typy zawartości dostępne, gdy homebrew Fumble jest pokazywane w Kompendium.',
