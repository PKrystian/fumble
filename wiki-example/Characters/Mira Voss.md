...
type: character
image: mira-voss.svg
summary: Harbormaster of Silverhaven, and the first friendly face most travelers meet.
tags: [npc]
facts:
  Race: Human
  Occupation: Harbormaster
  Home: '[[Silverhaven]]'
  Affiliation: '[[Silverhaven Harbor Guild]]'
---

**Mira Voss** runs the docks of [[Silverhaven]] with a ledger in one hand and a
grappling hook in the other. Sailors trust her word more than most contracts.

## Description

Weathered, sharp-eyed, and never without her harbor whistle. She's quick to laugh but
quicker to notice a ship riding low in the water.
...
```fumble-box
title: Around the Docks
Passive Perception: 15
Languages: Common, Aquan
Usually Carrying: Harbor whistle, ledger, cutlass
```
